...
class ConfService:
    ...
    service_url = os.getenv("SERVICE_URL", "https://eudi-issuer.codeinu.gr/")
    ...
    sample_data = {
        ...
        "employment_details":'[{"employment_type":"01", "name":"Danube Constructions", "employer_id":"889900", "id_type":"02", "street":"someStreet", "town":"someTown", "postal_code":"somePostal", "country_code":"GR"}]',
